      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6 font-mono text-sm scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent">
        <AnimatePresence initial={false}>
          {messages.map((msg) => (
            ...
            >
              <div
                className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 border shadow-lg ${msg.role === 'user'
              ...
              <div className={`flex-1 max-w-[85%] space-y-1`}>
                ...
                <div
                  className={`p-4 rounded-2xl leading-relaxed shadow-sm ${msg.role === 'user'
